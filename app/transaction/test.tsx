      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 my-6">
          <Card className="bg-gray-100 border rounded-2xl font-quantico">
            ...
            <CardContent>
              <p className="text-2xl text-center font-bold text-black">{stats.transactions24h.toLocaleString()}</p>
              <p className="text-green-500 text-sm text-center">Live updating</p>
            </CardContent>
          </Card>
          <Card className="bg-white border rounded-2xl font-quantico">
            ...
            <CardContent>
              ...
              <p className="text-gray-500 text-sm text-center">(Current)</p>
            </CardContent>
          </Card>
          <Card className="bg-white border rounded-2xl font-quantico">
            <CardHeader>
            ...
            <CardContent>
              ...
              <p className="text-gray-500 text-sm text-center">Safe gas price</p>
            </CardContent>
          </Card>
          <Card className="bg-white border rounded-2xl font-quantico">
            <CardHeader>
            ...
            <CardContent>
              ...
              <p className="text-gray-500 text-sm text-center">Average gas price</p>
            </CardContent>
          </Card>
        </div>
